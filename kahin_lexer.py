...
TURKCE_KEYWORDS = {
    ...
    'ac', 'topla', 'en_buyuk', 'en_kucuk',

    # Built-in (ek) — döngü/koleksiyon
    'numarali', 'birlikte', 'esle', 'suz', 'tersten',
    'herhangi', 'tumu', 'yuvarla', 'mantiksal',
    # Built-in (ek) — refleksiyon/OOP
    'ornegi_mi', 'niteligi_var', 'nitelik_al', 'nitelik_ata',
    'ust_sinif', 'degiskenler', 'nitelikler', 'kimlik',
    # Built-in (ek) — sayı/karakter/biçim
    'karakter', 'karakter_kodu', 'onaltilik', 'ikilik', 'sekizlik',
    'bicimle', 'gosterim', 'baytlar', 'bolum_kalan', 'us_al',
    # Built-in (ek) — yineleyici
    'yineleyici', 'sonraki', 'donmus_kume',
}
...
KEYWORD_MAP = {
    ...
    # Built-ins (ek) — döngü/koleksiyon
    'numarali': 'enumerate', 'birlikte': 'zip', 'esle': 'map',
    'suz': 'filter', 'tersten': 'reversed', 'herhangi': 'any',
    'tumu': 'all', 'yuvarla': 'round', 'mantiksal': 'bool',
    # Built-ins (ek) — refleksiyon/OOP
    'ornegi_mi': 'isinstance', 'niteligi_var': 'hasattr',
    'nitelik_al': 'getattr', 'nitelik_ata': 'setattr',
    'ust_sinif': 'super', 'degiskenler': 'vars',
    'nitelikler': 'dir', 'kimlik': 'id',
    # Built-ins (ek) — sayı/karakter/biçim
    'karakter': 'chr', 'karakter_kodu': 'ord', 'onaltilik': 'hex',
    'ikilik': 'bin', 'sekizlik': 'oct', 'bicimle': 'format',
    'gosterim': 'repr', 'baytlar': 'bytes', 'bolum_kalan': 'divmod',
    'us_al': 'pow',
    # Built-ins (ek) — yineleyici
    'yineleyici': 'iter', 'sonraki': 'next', 'donmus_kume': 'frozenset',
