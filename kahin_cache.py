...
"""
═══════════════════════════════════════════════════════════════════════
KAHİN BYTECODE CACHE - .pyc benzeri Implementation
═══════════════════════════════════════════════════════════════════════

CPython'un .pyc sistemi gibi çalışır.
Compiled bytecode'u cache'ler, tekrar compile etmekten kaçınır.

.pyc NEDİR:
-----------
Python Compiled Bytecode - CPython'un compile edilmiş cache'i

Örnek:
    program.py  → __pycache__/program.cpython-312.pyc
