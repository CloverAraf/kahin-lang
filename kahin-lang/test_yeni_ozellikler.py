#!/usr/bin/env python3
"""AST folding + aralik+/pipe sozdizimi kurallari"""
...
print("=== match/case (eslestir/desen) ===")
ns = calistir('eslestir 2:\n    desen 1:\n        r = "bir"\n    desen 2:\n        r = "iki"')
kontrol("literal desen", ns['r'] == "iki")
ns = calistir('eslestir 9:\n    desen 1:\n        r = "bir"\n    desen _:\n        r = "diger"')
kontrol("wildcard desen _", ns['r'] == "diger")
ns = calistir('eslestir 500:\n    desen 200 | 404:\n        r = "a"\n    desen 500 | 502:\n        r = "b"')
kontrol("OR desen (|)", ns['r'] == "b")
ns = calistir('eslestir (3, 4):\n    desen (x, y):\n        r = x + y')
kontrol("capture desen", ns['r'] == 7)
ns = calistir('eslestir 8:\n    desen n eger n > 5:\n        r = "buyuk"\n    desen _:\n        r = "kucuk"')
kontrol("guard (eger)", ns['r'] == "buyuk")
